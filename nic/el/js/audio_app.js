...
function handlePermissionDenial(err) {
    ...
    let messages = {
        ...
        el: {
            ...
            dismissed: "Παρακαλώ δοκιμάστε ξανά και επιλέξτε 'Επιτρέπεται' στο παράθυρο επιλογής ‘Αδειας.",
            settings: "Χρειαζεται να ενεργοποιήσετε την πρόσβαση στο μικρόφωνο στις ρυθμίσεις του προγράμματος διαδικτυακής περιήγησής.",
            notFound: "Δεν βρέθηκε μικρόφωνο. Βεβαιωθείτε ότι το μικρόφωνό σας είναι σωστά συνδεδεμένο.",
            unexpected: "Παρουσιάστηκε ένα απροσδόκητο σφάλμα. Παρακαλώ ελέγξτε τις ρυθμίσεις του προγράμματος περιήγησής σας ή δοκιμάστε ένα διαφορετικό πρόγραμμα διαδικτυακής περιήγησης."
        } 
    };
